...
class sell_downloads_tpleng {
	...
	//------------------------------------------------------------------------
	// Extract the template content, from option or file
	//------------------------------------------------------------------------
	function get_template_content ($file_name, $default = false)
	{
		$tpl = '';
		if((get_option('sd_custom_templates_active') || is_admin()) && !$default) $tpl = get_option($file_name, '');
		if(empty($tpl))
		{
			...
			if (file_exists($file_name))
			{
				...
				$tpl = fread($file_handle, filesize($file_name));
			}
		}
	...
	//------------------------------------------------------------------------
	// assign the template content to variable
	//------------------------------------------------------------------------
	function set_file ($var_name, $file_name) {
		$tpl = $this->get_template_content($file_name);
		if (!empty($tpl)) {
